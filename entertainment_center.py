...
becoming_jane = media.Movie("BECOMING JANE",
                    ...
                    "http://www.impawards.com/2007/posters/becoming_jane.jpg",
                    "https://www.youtube.com/watch?v=qmd-ej9Hx20")

notting_hill = media.Movie("NOTTING HILL",
                    "The life of a simple bookshop owner changes when he meets the most famous film star in the world. ",
                    "https://goddessella.files.wordpress.com/2012/03/notting-hill1.jpg",
                    "https://www.youtube.com/watch?v=4RI0QvaGoiI")

minions = media.Movie("MINIONS",
                    "Ever since the dawn of time, the Minions have lived to serve the most despicable of masters. ",
                    "http://www.flickeringmyth.com/wp-content/uploads/2015/06/minions-poster.jpg",
